...
import 'package:bikergo/main.dart';
...
class RegisterScreen extends StatelessWidget {
                          ...
                          onPressed: () {
                            if (nameTextEditingController.text.length < 6) {
                              displayToastMessage(
                                ...
                                .contains("@")) {
                              displayToastMessage(
                                  "email must be on it's proper form, example@example.com!",
                                  context);
  ...
  void registerNewUser(BuildContext context) async {
    ...
    {
      //save user informations to the database
      Map userDataMap = {
      ...
      //error-displaying error message or alert
